...
export default function ManagerSellingInvoiceDetailPage() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col w-full gap-4">
      <SellingInvoiceHeader
        ...
        status={invoice.status}
        listHref="/manager/invoices/selling"
      ...
      <div className="flex max-h-[30vh] min-h-0 shrink-0 flex-col gap-3 overflow-hidden lg:flex-row lg:items-stretch">
        <div className="flex min-h-0 min-w-0 flex-[2] flex-col">
          <SellingInvoiceReturnInvoicesCard
            sellingInvoiceNo={invoice.invoiceId}
          />
        </div>
      ...
      <CreateReturnSellingInvoicePopup
