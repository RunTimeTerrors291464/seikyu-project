...
@Controller({
    path: 'api/v1/stock-adjustment-invoices',
    version: '1',
})
...
export class StockAdjustmentInvoiceController {
    ...
    // POST /api/v1/stock-adjustment-invoices
    @Post()
    @Roles(Role.MANAGER)
    ...
    // PATCH /api/v1/stock-adjustment-invoices
    @Patch()
    @Roles(Role.MANAGER)
    ...
    // DELETE /api/v1/stock-adjustment-invoices
    @Delete()
    @Roles(Role.MANAGER)
    ...
    // POST /api/v1/stock-adjustment-invoices/:id/confirm
    @Post(':id/confirm')
    @Roles(Role.MANAGER)
    ...
    // GET /api/v1/stock-adjustment-invoices
    @Get()
    ...
    // GET /api/v1/stock-adjustment-invoices/:id
    @Get(':id')
    @Roles(Role.MANAGER, Role.ADMIN)
