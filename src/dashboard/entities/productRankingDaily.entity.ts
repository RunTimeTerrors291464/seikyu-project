...
@Entity('product_ranking_daily')
@Unique(['productId', 'invoiceType', 'day', 'month', 'year'])
export class ProductRankingDailyEntity {
    ...
    // --- Relationships ---
    @ManyToOne(() => ProductsEntity, (product) => product.dailyRankings, { onDelete: 'CASCADE' })
