...
export class CreateAndAddIndexReturnImportInvoiceTablesV11771780369697 implements MigrationInterface {
    name = 'CreateAndAddIndexReturnImportInvoiceTablesV11771780369697'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // --- RETURN_IMPORT_INVOICE_PRODUCTS INDEXES ---
        // --- Single column B-tree index ---
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            CREATE INDEX idx_return_import_invoice_products_product_id 
            ON return_import_invoice_products (product_id)
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // --- RETURN_IMPORT_INVOICE_PRODUCTS INDEXES ---
        await queryRunner.query(`DROP INDEX IF EXISTS idx_return_import_invoice_products_product_id`);
