export enum ErrorCode {
    ...
    ACTIVATE_PRODUCT_SERVICE = 4106,
    DEACTIVATE_PRODUCT_SERVICE = 4107,
    GET_PRODUCT_HISTORY_LIST_SERVICE = 4108,
    GET_PRODUCT_HISTORY_BY_VERSION_SERVICE = 4109,
    UPDATE_INVENTORY_STOCK_BULK_SERVICE = 4110,
    GET_PRODUCT_STOCK_HISTORY_LIST_SERVICE = 4111,
