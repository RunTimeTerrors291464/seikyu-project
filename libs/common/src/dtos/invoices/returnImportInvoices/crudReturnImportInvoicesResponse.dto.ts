...
// Import enums.
import { ReturnImportInvoiceStatus } from '../../../enums/invoiceStatus.enum';
...
export class ReturnImportInvoiceProductResponseDto {
    ...
    @ApiProperty({
        description: 'Total return price for this product (returnQuantity * importPrice)',
        example: 50000,
    })
...
export class ReturnImportInvoiceWithoutProductsDto {
    ...
    @ApiPropertyOptional({
        description: 'Return invoice ID (format: RIYY-XXXXX). Only assigned when confirmed',
        example: 'RI25-00001',
        nullable: true,
    })
    returnInvoiceId: string | null;
