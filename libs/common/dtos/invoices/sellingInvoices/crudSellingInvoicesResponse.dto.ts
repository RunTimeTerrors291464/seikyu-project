...
export class SellingInvoiceProductResponseDto {
    ...
    @ApiProperty({
        description: 'Selling invoice product line UUID',
    ...
    @ApiProperty({
        description: 'Quantity returned (accumulated from return invoices)',
        example: 0,
    })
    ...
    @ApiProperty({
        description: 'Discount applied to this product line (absolute amount)',
        example: 5000,
    })
    productDiscount: number;

    @ApiProperty({
        description: 'Total selling price for this product line',
        example: 145000,
    })
...
export class SellingInvoiceResponseDto {
    ...
    @ApiProperty({
        description: 'Invoice-level discount (absolute amount)',
        example: 10000,
    })
    invoiceDiscount: number;

    @ApiProperty({
        description: 'Total selling price for the entire invoice after discounts',
        example: 440000,
    })
    totalSellingPrice: number;
    ...
    @ApiProperty({
        description: 'Number of return selling invoices linked to this invoice',
        example: 0,
    })
    returnCount: number;
